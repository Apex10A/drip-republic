  ...
  return (
    <section className="bg-white py-16 min-h-[700px] flex flex-col items-center justify-center">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-12 text-black">Why Choose Drip Republic?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center text-center p-6 rounded-lg hover:bg-gray-50 transition-colors">
            ...
            <h3 className="text-xl font-semibold mb-3 opacity-[0.8] text-gray-600">Affordable</h3>
          ...
          <div className="flex flex-col items-center text-center p-6 rounded-lg hover:bg-gray-50 transition-colors">
            ...
            <h3 className="text-xl font-semibold mb-3 opacity-[0.8] text-gray-600">Quality</h3>
          ...
          <div className="flex flex-col items-center text-center p-6 rounded-lg hover:bg-gray-50 transition-colors">
            ...
            <h3 className="text-xl font-semibold mb-3 opacity-[0.8] text-gray-600">Reliable</h3>
